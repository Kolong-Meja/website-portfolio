...
class ContentSeeder extends Seeder
{
    ...
    {   
        ...
        Content::create([
            ...
            'description-english' => "Hello brothers and sisters, I am Faisal Ramadhan. I am a student majoring in information systems. Before I got into the world of technology, I used to be just a kid who spent more time with games. I really like games, especially games from playstation 2 and nintendo ds. As a child I never thought I would become a programmer. In fact, I used to think, to want to be a graphic designer.
